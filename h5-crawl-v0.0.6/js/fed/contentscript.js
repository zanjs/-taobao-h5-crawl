 ...
 PD.getScript("https://browser-extensions.github.io/PanCrawl/src/libs/panli.js", function(data, status, jqxhr) {
   ...
   PD(function() {
     ...
     getSetTimeoutF(function(dTime) {
       ...
       var timeOut = timeRandom(dTime)

       console.log('等待执行' + timeOut)
 ...
 // 模拟时间打乱
 function timeRandom(time) {
   var chars = ['0', '2000', '4000', '9000', '12000'];

   return (chars[parseInt(Math.random() * 5)] - 0) + (time - 0) + parseInt(Math.random() * 5 * 1000)
